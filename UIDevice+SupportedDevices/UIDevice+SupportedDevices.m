...
+ (NSString *)supportedDeviceName
{
    ...
    else if ([machineName isEqualToString:@"iPad4,5"]) deviceName = @"iPadMini";            // iPad Mini 2G Cellular (SAME AS iPAD MINI 1)
    ...
    else if ([machineName isEqualToString:@"iPhone7,1"]) deviceName = @"iPhone5s";          // iPhone 6 (SAME AS iPHONE 5s)
    else if ([machineName isEqualToString:@"iPhone7,2"]) deviceName = @"iPhone5s";          // iPhone 6+ (SAME AS iPHONE 5s)
